...
{
private:
  // using hash<int> as the hash function suggests that the keys are of integer type,
  // and using a hash function that is optimized for integer keys can improve the performance
  // of the unordered_map container.
