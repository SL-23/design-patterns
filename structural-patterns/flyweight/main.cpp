...
struct UniqueState
{
  ...
  {
    return os << "[" << ss.owner_ << ", " << ss.plates_ << "]";
  }
};
...
public:
  ...
  Flyweight GetFlyweight(const SharedState &shared_state)
  {
    ...
    {
      cout << "cant find a flyweight, creating a new one.\n";
      this->flyweights_.insert(make_pair(key, Flyweight(&shared_state)));
    }
    else
      cout << "Flyweight factory: reusing existing flyweight.\n";
...
void AddCarToPoliceDatabase(FlyweightFactory &ff, const string &plates, const string &owner, const string &brand, const string &model, const string &color)
{
